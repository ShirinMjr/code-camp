 ...
 * There will be a base case. The base case tells the recursive function when it no longer needs to call
 * itself. It is a simple case where the return value is already known.
 ...
 * If the function is called with a number less than 1, t
